...
– 2 Public subnets
![public subnets](images/public-subnets.png)
...
![internetgateway1](images/internetgateway1.png)

– 1 NAT Gateway
![natgateway](images/natgateway.png)
![natgateway1](images/natgateway1.png)

– 1 EIP
![Elastic IP](images/elasticip.png)
![Elastic IP](images/elasticip1.png)

– 2 Route tables
![private-rtb](images/private-rtb.png)
![public-rtb](images/public-rtb.png)
...
3. Create an external (Internet facing) [Application Load Balancer (ALB)](https://docs.aws.amazon.com/elasticloadbalancing/latest/application/application-load-balancer-getting-started.html)
   Create a file called <mark>alb.tf</mark>
...
````
![EFS](images/EFS.png)
![EFS-Mount target id](images/EFS-mountargetid.png)
![EFS access poinits](images/EFS.png)
...
Now, we are almost done but we need to update the last file which is <mark>terraform.tfvars</mark> file. In this file we are going to declare the values for the variables in our <mark>varibales.tf</mark> file.

Open the <mark>terraform.tfvars</mark> file and add the code below
